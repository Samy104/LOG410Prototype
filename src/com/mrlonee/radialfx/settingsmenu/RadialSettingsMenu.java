...
public class RadialSettingsMenu extends Group {
	...
	addMenuItem("resources/icons/gemicon/PNG/64x64/row 16/1.png");
	addMenuItem("resources/icons/gemicon/PNG/64x64/row 16/2.png");
	addMenuItem("resources/icons/gemicon/PNG/64x64/row 16/3.png");
	addMenuItem("resources/icons/gemicon/PNG/64x64/row 16/4.png");
	...
	final ImageView centerView = getImageView(iconPath);
	final ImageView value1View = getImageView(iconPath);
	final ImageView value2View = getImageView(iconPath);
	...
	Group valueGroup;
	if (Math.random() < 0.5) {
	    final ImageView value3View = getImageView(iconPath);
